...
def app():
    ...
    if uploaded_file is not None:
        ...
        st.image(image, caption="Uploaded image", use_column_width= True) #determines whether the image should be displayed at full width or the width of a single column.
